...
available in an R-file: 05_performance_measures.R. This file executes the complete code 
properly. Code parts in this qmd-file that couldn't be run due to this issue with h2o
where not executed, but only displayed. Instead the plots that I got from running the 
R file, are displayed.
